...
#include <iostream>
#include "InitFunc.h"
#include <glm/glm.hpp>	//glm是向量、举证库
...
GLFWwindow* InitSet()
{
   ...
   // ------------------------------
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "ZhouYongYang's Rendering Work", NULL, NULL);
    if (window == NULL)
    {
...
void cameraSet(Shader& shader)
{
    ...
    shader.setMat4("view", view, false);
}
...
const unsigned int loadHDRenvMap(string path)
{
